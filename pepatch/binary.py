...
class Binary(object):
    ...
    def __init__(self, filename):
        ...
        section.Misc_VirtualSize += self.roundup(self.DEFAULT_AMPLIFY_SIZE, self.pefile.NT_HEADERS.OPTIONAL_HEADER.SectionAlignment)
        self.pefile.NT_HEADERS.OPTIONAL_HEADER.SizeOfImage = section.VirtualAddress + section.Misc_VirtualSize
